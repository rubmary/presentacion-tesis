...
\pgfdeclareimage[width=22pt]{mine}{../images/mine}
...
\mode<beamer>{
  ...
  % \date{\textbf{IJCAI. New York, USA. July 2016.}}
}
...
\begin{frame}{\Large Objetivos}
\begin{block}{Objetivo General}
Comprender los conceptos en el \'area de juegos de dos personas que involucran informaci\'on incompleta y no determinismo, as\'i como implementar los algoritmos para resolverlos, realizando experimentos sobre distintos juegos que son capturados por el modelo.
\end{block}
\begin{itemize}
