...
\begin{tabular}{@{}ccccccc@{}}
  ...
  & & & & & & \\
  \onslide<6,10->{Ciencias sociales} & \quad &
  \onslide<7,10->{Econom\'ia} & \quad &
  \onslide<8,10->{Matem\'atica} & \quad &
  \onslide<9,10->{Computaci\'on} \\
\end{tabular}
\end{center}
\end{frame}
...
\begin{enumerate}
  ...
  \visible<9->{\onslide<9,10->{\item El segundo jugador puded garantizar una ganancia esperada de \textbf{al menos} $-u$ independientemente de la estrategia de su oponente.}}
\end{enumerate}
\end{frame}
...
\begin{enumerate}
  ...
  \visible<3->{\onslide<3,8->{\item A tiempo $t+1$ cada jugador elige una acci\'on siguiente una estrategia mixta determinada.}}
...
\begin{enumerate}
  ...
  \visible<4->{\onslide<4,9->{\item Supongamos que el regret incondicional de cualquier acci\'on es menor que $\varepsilon > 0$.}}
  \begin{itemize}
    \visible<5->{\onslide<5,9->{\item La estrategia emp\'irica es una aproximaci\'on a un equilibrio de Nash que se encuentra una distancia no mayor que $2\varepsilon$.}}
    \visible<6->{\onslide<6,9->{\item $2\varepsilon$-equilibrio de Nash.}}
  \end{itemize}
\end{enumerate}
\vspace{.3cm}
...
\begin{tabular}{l r r r}
    ...
    \onslide<2,3,8->{Ganancia esperada $u(\sigma)$ & $0,000$ & $0,000$ & $0,000$} \\
    \onslide<2,4,8->{Explotabilidad $\varepsilon_{\sigma}$ & $0,006$ & $0,006$ & $0,008$} \\
    \onslide<2,5,8->{Tiempo $T$ & $10,276$ & $0,777$ & $0,042$} \\
    \onslide<2,6,8->{Iteraciones $I$ & $3.892.550,4$ & $25.616,6$ & $16.260,5$}   \\
    \onslide<2,7,8->{$T/I$ & $2,64{\times}10^{-6}$ & $3,03{\times}10^{-5}$ & $2,58{\times}10^{-6}$} \\
    \bottomrule
\end{tabular}
} \end{center}
}
\visible<8->{\graphicsRM{matching-pennies}}
\end{frame}
...
\begin{tabular}{l r r r}
    \toprule
    & \multicolumn{1}{c}{A} & \multicolumn{1}{c}{B} & \multicolumn{1}{c}{C} \\ \midrule
    \onslide<2,3,8->{Ganancia esperada $u(\sigma)$ & $-0,000012$ & $0,000004$ & $0,000022$} \\
    \onslide<2,4,8->{Explotabilidad $\varepsilon_{\sigma}$ &  $0,006$ & $0,010$ & $0,009$} \\
    \onslide<2,5,8->{Tiempo $T$ & $12,198$ & $0,345$ & $0,049$} \\
    \onslide<2,6,8->{Iteraciones $I$ & $4.519.054,1$ & $6.601,3$ &  $19.321,1$} \\
    \onslide<2,7,8->{$T/I$ & $2,70{\times}10^{-6}$ & $5,23{\times}10^{-5}$ & $2,54{\times}10^{-6}$} \\
    \bottomrule
\end{tabular}
} \end{center}
}
\visible<8->{\graphicsRM{RPS}}
\end{frame}

\begin{frame}{\Large Resultados Experimentales}
\Alert{Ficha vs. Domin\'o}
\vspace{.3cm}
\begin{columns}
\column{.45\textwidth}
