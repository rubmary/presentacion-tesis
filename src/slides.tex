...
\begin{frame}
  ...
  \vspace{.25cm}
  \centering{\url{rubmary-domino-app.appspot.com}}
\end{frame}
...
\begin{frame}{\Large Demo (2)}

\Alert{Valor del Juego: $u \approx 2.15323$}
\vspace{.25cm}
...
\includemedia[
  ...
  passcontext,
  transparent,
  addresource=../demos/corrida,
  flashvars={source=../demos/corrida}
]{\includegraphics[width=\textwidth]{../demos/corridas.png}}{VPlayer.swf}
\end{center}
\end{frame}
