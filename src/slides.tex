...
\end{block}
\vspace{.5cm}
\visible<5->{\Alert{Aplicaciones}}
\begin{center}
\begin{tabular}{@{}cccc@{}}
  \visible<6->{\includegraphics[height=.15\textwidth]{../images/ciencias_sociales.png}} &
  \visible<7->{\includegraphics[height=.15\textwidth]{../images/economia.png}} &
  \visible<8->{\includegraphics[height=.15\textwidth]{../images/matematica.png}} &
  \visible<9->{\includegraphics[height=.15\textwidth]{../images/computacion.png}} \\
  & & & \\
  \visible<6->{\textbf{Ciencias sociales}} &
  \visible<7->{\textbf{Econom\'ia}} &
  \visible<8->{\textbf{Matem\'atica}} &
  \visible<9->{\textbf{Computaci\'on}} \\
\end{tabular}
\end{center}
\end{frame}
...
\begin{enumerate}
  \visible<2->{ \onslide<2, 13->{\item $4$ juegos para dos jugadores de suma cero.}}
  \visible<3->{ \onslide<3, 13->{\item $10$ corridas por cada uno de los juegos y cada uno de los procedimientos.}}
  \visible<4->{ \onslide<4, 13->{\item Criterio de parada: regret incondicional menor que $0.005$.}}
  \visible<5->{ \onslide<5, 13->{\item Comprobaci\'on con un problema equivalente de programaci\'on lineal.}}%
  \visible<6->{ \onslide<6, 13->{\item Gr\'aficas del regret con respecto al n\'umero de iteraciones.}}
...
\begin{enumerate}
  \visible<4->{\onslide<4-6,15->{\item Estrategias Puras.}}
  \visible<8->{\onslide<8-10,15->{\item Estrategias Mixtas.}}
  \visible<9->{\onslide<9-10,15->{\begin{tabular}{@{}cccc@{}}
  \cmidrule{1-4}
  (L, $a$) & (L, $b$) & (R, $a$) & (R, $b$) \\
  $0.45$ & $0.30$ & $0.00$ &  $0.25$ \\ \cmidrule{1-4}
  \end{tabular}}}
  \visible<10->{\onslide<10,15->{\begin{tabular}{@{}ccc@{}}
  \cmidrule{1-3}
  A & B & C \\
  $0.25$ & $0.25$ & $0.50$ \\
  \cmidrule{1-3}
  \end{tabular}}}
  \visible<11->{\onslide<11-12,15->{\item Estrategias de Comportamiento.}}
  \visible<12->{\onslide<12,15->{\begin{tabular}{@{}cccc@{}}
