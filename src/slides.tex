...
\column{.5\textwidth}
\begin{enumerate}
  \onslide<11,13->{\item La ficha y el domin\'o no se superponen: gana el jugador 1.}
  \onslide<12,13->{\item La ficha y el domin\'o s\'i se superponen: gana el jugador 2.}
\end{enumerate}
}
\column{.45\textwidth}
\visible<10->{%
...
\begin{enumerate}
  \visible<4->{\onslide<4-6,13->{\item Estrategias Puras.}}
  \visible<7->{\onslide<7-9,13->{\item Estrategias Mixtas.}}
  \visible<8->{\onslide<8-9,13->{\begin{tabular}{@{}cccc@{}}
  \cmidrule{1-4}
  (L, $l$) & (L, $r$) & (R, $l$) & (R, $r$) \\
  $0.45$ & $0.30$ & $0.00$ &  $0.25$ \\ \cmidrule{1-4}
  \end{tabular}}}
  \visible<9->{\onslide<9,13->{\begin{tabular}{@{}ccc@{}}
  \cmidrule{1-3}
  A & B & C \\
  $0.25$ & $0.25$ & $0.50$ \\
  \cmidrule{1-3}
  \end{tabular}}}
  \visible<10->{\onslide<10-11,13->{\item Estrategias de Comportamiento.}}
  \visible<11->{\onslide<11,13->{\begin{tabular}{@{}cccc@{}}
...
\end{enumerate}
\vspace{.3cm}
\visible<12->{\Alert{Equilibrio de Nash}\\
