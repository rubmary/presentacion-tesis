...
\end{block}
\visible<2->{{\cutpic{5mm}{.32\textwidth}{../images/dados.jpg}}}
\end{center}

\column{.45\textwidth}
\begin{center}
\begin{block}{Informaci\'on incompleta}
\visible<3->{Informaci\'on parcial sobre algunas de las acciones que fueron tomadas previamente.}%
\end{block}
\visible<3->{{\cutpic{5mm}{.32\textwidth}{../images/poker.jpg}}}
\end{center}
\end{columns}
