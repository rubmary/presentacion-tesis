...
\begin{frame}{\Large Presentaciones din\'amicas}
\begin{itemize}
    \item Lo
    \item<2-> que
    \item<3-> empieza
...
\begin{frame}{\Large Otras animaciones}
